...
```{r}
dane2 <- read.csv("HipotecznyPoprawiony", header = TRUE)
View(dane2)
dane2$TotalIncome <- dane2$ApplicantIncome + dane2$CoapplicantIncome ## stworzenie zmiennej łączny przychód gospodarstwa domowego ubiegającego się o kredyt
head(dane2)
dane2$DebtToIncomeRatio <-dane2$LoanAmount / dane2$TotalIncome ## stworzenie zmiennej stosunek długu do łącznych przychdów gospodarstwa domowego
head(dane2)
